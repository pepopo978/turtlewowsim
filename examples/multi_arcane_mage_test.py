...
for i in range(num_mages):
    if i == 0:
        fm = Mage(name=f'arcane_surge_rupture_missiles', sp=1000, crit=40, hit=16, haste=24,
                  tal=ArcaneMageTalents,
                  opts=MageOptions(t3_8_set=False, extra_second_arcane_missile=False, use_presence_of_mind_on_cd=False),
...
sim.run(iterations=20000, duration=120, print_casts=False)
sim.detailed_report()
